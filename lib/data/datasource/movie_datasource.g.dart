...
class _MovieDataSource implements MovieDataSource {
  ...
  Future<BoxOfficeResponseModel> getDailyBoxOffice(
      DailyBoxOfficeRequestModel dailyBoxOfficeRequestModel) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<BoxOfficeResponseModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = BoxOfficeResponseModel.fromJson(_result.data!);
    return value;
  }
